...
const TermsOfService = () => {
  return (
    <div>
      <h1>Điều khoảng dịch vụ</h1>
      <h2>1. Giới thiệu</h2>
      <p>
        Chào mừng quý khách hàng đến với website chúng tôi. Khi quý khách hàng
        truy cập vào trang website của chúng tôi có nghĩa là quý khách đồng ý
        ...
        nghĩa là quý khách chấp nhận với những thay đổi đó. Quý khách hàng vui
      ...
      <p>
        ...
        hóa theo quy định hiện hành của pháp luật Việt Nam. Trong suốt quá trình
        đăng ký, quý khách đồng ý nhận email quảng cáo từ website. Nếu không
      ...
      <p>
        ...
        Cách 1: Thanh toán trực tiếp (người
        mua nhận hàng tại địa chỉ người bán) 
        Cách 2: Thanh toán sau (COD – giao
